...
cids = ['CSCE 310', 'CSCE 420', 'CSCE 436', 'CSCE 441', 'CSCE 443', 'CSCE 444', 'CSCE 445', 'CSCE 452', 'CSCE 470']
filename = 'csce.html'
...
for num in range(0, cids.__len__()):
    if __name__ == "__main__":
        print ('Processing class: ' + cids[num])
